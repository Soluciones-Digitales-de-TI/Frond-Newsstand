      ...
      <div className="bg-white mt-10 px-5 py-10">
        ...
        <form>
          ...
          <div className="mb-4 flex">
            ...
            <div class="w-full text-right flex justify-center items-center">
              <a href="#" class="text-indigo-600 hover:text-indigo-800 transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105">
